            ...
            <div class="card card1">
                <div class="row justify-content-center my-auto">
                    <div class="col-md-8 col-10 my-5">
                        <form action="<?php echo base_url('signup/signupdata'); ?>" method="POST">
                            ...
                            <div class="form-group"> <label class="form-control-label text-muted">Ad</label> <input
                                    type="text" id="ad" name="First_Name" placeholder="Ad" class="form-control"> </div>
                            <div class="form-group"> <label class="form-control-label text-muted">Soyad</label> <input
                                    type="text" id="soyad" name="Last_Name" placeholder="Soyad" class="form-control">
                            </div>
                            <div class="form-group"> <label class="form-control-label text-muted">Şehir</label> <input
                                    type="text" id="sehir" name="city" placeholder="Şehir" class="form-control"> </div>
